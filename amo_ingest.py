...
N_COMMITS     = 100          # first N commits (oldest → newest)
EMBED_MODEL   = "nvidia/llama-nemotron-embed-vl-1b-v2:free"
EMBED_DIMS    = 2048
OUT_NODES     = "amo_nodes.json"
OUT_EDGES     = "amo_edges.json"
EMBED_DELAY   = 0.2          # seconds between embedding calls (rate limit safety)
