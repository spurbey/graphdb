...
# â”€â”€ Optional --data-dir flag â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
try:
    ...
    print(f"[graph_mcp_server] igraph pipeline ready (data={_DATA_ROOT}); import sys; sys.stdout.flush()")
except Exception as _e:
    print(f"[graph_mcp_server] igraph pipeline unavailable, will use HelixDB fallback: {_e}"); import sys; sys.stdout.flush()
    ...
    "tools": [
        {
            ...
            "description": (
                ...
                "plus edges between them. Better than raw vector search â€” finds structurally "
        ...
        },
        {
            ...
            "description": "Show how a function changed â€” returns current state and its previous version.",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": "Find all functions that call a given function, up to N hops deep. Single Rust traversal â€” no client-side looping.",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": "Find callers of a function whose code was committed before a given date â€” useful for tracing stale dependencies.",
            "parameters": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": (
                ...
                "Uses GraphSAGE structural embeddings â€” finds functions at the same call depth "
...
if __name__ == "__main__":
    ...
    print(f"Graph MCP server running on http://127.0.0.1:{PORT}"); import sys; sys.stdout.flush()
    print("Tools: search_code_semantics (igraph pure vector); import sys; sys.stdout.flush() | search_code_semantics_helix (HelixDB) | get_code_time_travel_diff | trace_blast_radius | get_temporal_vulnerability_trace | edit_code")
